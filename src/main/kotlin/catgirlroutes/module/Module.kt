 ...
 * These are shown in the following on the example of a [NumberSetting][catgirlroutes.module.settings.impl.NumberSetting].
 ...
 * The sample from [AutoClicker][catgirlroutes.module.impl.misc.AutoClicker] below shows both of these being used.
 ...
 * @param description A description of the module and its usage that is shown in the [Advanced GUI][catgirlroutes.ui.clickgui.advanced.AdvancedMenu].
 * @sample catgirlroutes.module.impl.misc.AutoClicker.maxCps
 * @sample catgirlroutes.module.impl.misc.AutoSprint
 */
abstract class Module(
    ...
    /**
     * A description of the module and its usage that is shown in the [Advanced GUI][catgirlroutes.ui.clickgui.advanced.AdvancedMenu].
     */
     ...
     *
     * @sample catgirlroutes.module.impl.player.FreeCam.onEnable
     */
    open fun onEnable() {
        MinecraftForge.EVENT_BUS.register(this)

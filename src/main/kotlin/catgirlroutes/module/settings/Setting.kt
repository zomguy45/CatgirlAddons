 ...
 *
 * To avoid nullability you can use [DummySetting][catgirlroutes.module.settings.impl.DummySetting] instead of null.
 *
 * @author Aton
 */
abstract class Setting<T>(
    ...
    val shouldBeVisible: Boolean
        get() {
            return (dropdownDependency?.enabled ?: true) && visibilityDependency()
        }

...
class AdvancedElementColor2(
    parent: AdvancedMenu, module: Module, setting: ColorSetting2,
) : AdvancedElement<ColorSetting2>(parent, module, setting, AdvancedElementType.COLOR2) {
